...
import { ProfileOutlined, FileTextOutlined, BellOutlined, UserAddOutlined } from '@ant-design/icons'
              ...
              <Menu defaultSelectedKeys={["File"]}>
                {list.map((item) => (
                  <Menu.Item
                    key={item.name}
                    icon={item.icon}
                    className={cx(styles.btnItem, item.name === Page ? styles.active : styles.unactive)}
