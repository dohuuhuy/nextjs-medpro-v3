import BannerContact from '@components/test/BannerContact'
import React from 'react'

const bannerContact = {
    "title":"Liên hệ với chúng tôi",
    "subTitle":"Bạn đang quan tâm đến các dịch vụ của chúng tôi hoặc cần tư vấn!<br/>Chúng tôi luôn sẵn sàng giúp đỡ bạn",
    ...
    cardContact: [
    {
        ...
        key:"question",
        title: "Hỏi đáp nhanh",
        subtiltle:"Danh sách các câu hỏi đã được hệ thống hóa, bạn có thể tham khảo nhanh",
        img: [
        {
...
const index = () => {
    return (
        <BannerContact dataBannerContact={bannerContact} />
    )
}
