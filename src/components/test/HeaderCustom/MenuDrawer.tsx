...
const MenuDrawer= ({ setDrawer, closeDrawer, Menu, Authencartion, logo }: Props) =>{
                ...
                {isAuthen ? (
                        <Row className={style.rowUser}>
                            <Col className={style.colIcon}>
                                <img src={"https://medpro.com.vn/static/media/medpro_circle.dc9c7663.svg"} />
                            </Col>
                            <Col className={style.colName}>
                                    Xin Chào 
                                    <b className={style.nameUser}> 
                                        {nameUser} 
                                    </b>
                            </Col>
                        </Row>
                    ) : (
                        <Button href="/" type="default" size="large" className={style.btnSign}>
                            <p className={style.textBtnSign}>
                                Đăng nhập tài khoản
                            </p>
                        </Button>
                    )
                ...
                {isAuthen ? (
                        <Button href={"/login"} 
                            ...
                            <Col className={style.colText}>
                                <b className={style.textBtnLogout}>
                                    Đăng xuất
                                </b>
                            </Col>
                        </Button>
