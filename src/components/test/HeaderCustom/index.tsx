...
const HeaderCustom = ({ dataHeader, Authencartion }: PropsHeader) => {
    ...
    const { logoHeader, logoMobile, menu, menuMobile, listSupport, support }: any = dataHeader;
        ...
        <Row className={style.header}>
            <Col className={style.wapper}>
                <a href="#" className={style.linkLogo}>
                    <img className={style.logo_brand} src={logoHeader} alt="Logo for website destop" />
                    <img className={style.logo_responesive} src={logoMobile} alt="Logo for website mobile" />
                </a>
            </Col>
